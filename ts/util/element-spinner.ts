...
export default class ElementSpinner {
    ...
    static spinElement(element: HTMLElement) {
        ...
        Configuration.elementVisibilityFunction(element, false);
    }


    /**
     * Restore the passed element.
     *
     * @param element
     */
